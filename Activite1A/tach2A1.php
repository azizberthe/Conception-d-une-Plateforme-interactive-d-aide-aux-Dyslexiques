    ...
    <div class="div" style="background-image: url(t4.jpg);">
        <div class="cont container">
            ...
            <div class="droppable-elements row">
                ...
                <div class="col"><span><font size="+5">د</font></span> </div>
                <div class="col"><span><font size="+5">ض</font></span></div>   
				<div class=" col"><span><font size="+5">ظ</font></span> </div>
                <div class="col"><span><font size="+5">ط</font></span></div>
            </div>
            <div class="droppable-elements row">
                ...
                <div id="2" class="droppable col col-2" ondrop="drop(event,this.id)" ondragover="allowDrop(event)" data-draggable-id="ض">
                    
                </div>
                <div id="3" class="droppable col col-2" ondrop="drop(event,this.id)" ondragover="allowDrop(event)" data-draggable-id="ظ">
                    
                </div>
                <div id="4" class="droppable col col-2" ondrop="drop(event,this.id)" ondragover="allowDrop(event)" data-draggable-id="ط">
