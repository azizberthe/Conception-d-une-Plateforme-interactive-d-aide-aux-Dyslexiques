		...
		<div  class="cont container">
			...
			<div class="row">
				<div class="col offset-3">
					<img src="serie1.png" alt="#" width="500">	
				</div>
			</div>
			<div class="row">
				<div class="col offset-3">
			...
			<div class="row offset-4">
				<div class="col">
					<button onclick="verification();"  class="btn"><img src="vrai.png" width="70"></button>
					<button onclick="verification1();"  class="btn"><img src="faux.png" width="70"></button>
			...
			<div class="row">
					<div class="col">
						 <a href="../Activite1B/tach2A1.php"><img src="ico4.png" width="100"></a>
					</div>
					<div class="col offset-4 text-end">
						<a href="../Activite1B/tache3A1.php"><img src="ico3.png" width="100"></a>
					</div>
				</div>
