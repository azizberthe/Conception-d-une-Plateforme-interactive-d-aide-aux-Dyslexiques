  ...
  try
	{
	  if(data=='img3' && id=='1')
		j++;
	  else if (data=='img4' && id=='2')
		  j++;
	  else if (data=='img1' && id=='3')
		  j++;
	  else if (data=='img2' && id=='4')
		  j++;
	} 
	catch (error)
	{
        ...
        <div class="cont container">
            <div class="row offset-3">
			 ...
			 <div class="droppable-elements row">
                ...
                <div class="col"><span><font size="+5" >هـ</font></span> </div>
                <div class="col"><span><font size="+5" >ج</font></span></div>   
				<div class=" col"><span><font size="+5" >ف</font></span> </div>
                <div class="col"><span><font size="+5" >ب</font></span></div>
            </div>
            ...
            <div class="droppable-elements row">
                ...
                <div id="2" class="droppable col col-2" ondrop="drop(event,this.id)" ondragover="allowDrop(event)">
                    
                </div>
                <div id="3" class="droppable col col-2" ondrop="drop(event,this.id)" ondragover="allowDrop(event)">
                    
                </div>
                <div id="4" class="droppable col col-2" ondrop="drop(event,this.id)" ondragover="allowDrop(event)">
                   
                </div>
            </div>
            <div class="draggable-elements row">
                <div class="col fas fa-dal draggable"  style="color: #ff6384;" id="1">
                    <img id="img3" src="f.png" draggable="true" ondragstart="drag(event)" width="200">
                </div>  
                <div class="col fas fa-dadd  draggable" style="color: #36a2eb;" id="2">
                    <img id="img4" src="b.png" draggable="true" ondragstart="drag(event)" width="200">
                </div>
                <div class="col fas fa-dade draggable"  style="color: #ffce56;" id="3">
                    <img id="img1" src="h.png" draggable="true" ondragstart="drag(event)" width="200">
                </div>
                <div class="col fas fa-taa draggable"  style="color: #9966ff;" id="4">
                    <img id="img2" src="j.png" draggable="true" ondragstart="drag(event)" width="200">
                </div>
            ...
            <div class="row">
                <div class="col">
                    <a href="../Activite1A/tach2A1.php"> <img src="ico4.png" width="100"></a>
                </div>
                <div class="col offset-4 text-end">
                    <a href="../Activite1A/tache3A1.php"><img src="ico3.png" width="100"></a>
                </div>
			</div>
