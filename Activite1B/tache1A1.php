...
<body>
	<div class="div" style="background-image: url(t1.jpg);">
		<div class="cont container">
			...
			<div class="row offset-1">
				<div class="col">
					<button  onclick ="playtest('3');" class="btn">
						<img width="200" src="cerYaa.png" >
					</button>
				</div>
				<div class="col">
					<button onclick ="playtest('4');" class="btn">
						<img src="cerGha.png"  width="200">
					</button>
				</div>
				<div class="col">
			...
			<div class="row">
                <div class="col">
                   <a href="../Activite1A/tache1A1.php"> <img src="ico4.png" width="100"></a>
                </div>
                <div class="col offset-4 text-end">
                    <a href="../Activite1A/tach2A1.php"><img src="ico3.png" width="100"></a>
                </div>
			</div>
	...
	<audio id="1"  src ="wa.mp3" ></audio>
	<audio id="2"  src ="jem.mp3" ></audio>
	<audio id="3"  src ="ya.mp3" ></audio>
	<audio id="4"  src ="ghain.mp3" ></audio>
