...
<body>
   <div class="div">
        ...
        <div class="cont container">
            ...
            <form class="row col-8 offset-2 reg" method="POST" action="ajoutprof.php" >
                <div class="col-3">
                ...
                <div class="col-9">
                    ...
                    <div class="row form-group">
                        <div class="col-6 text-center">
                            <input type="radio" class="form control-form" name="sexe" id="sexe" value="Homme" />
                            <label> : ذكر</label><br>
                            <input type="radio" class="form control-form" name="sexe" id="sexe" value="Femme" />
                            <label> : أنثى</label>
                        </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-6"><label for="gmail" class="label control-label">: البريد الإلكتروني</label></div>
                    </div>
                    <div class="row form-group">
                        <div class="col-6"><input type="text" class="form control-form" name="psd" id="psd" required /></div>
                        <div class="col-6"><label for="psd" class="label control-label"> :كلمة السر</label></div>
                    </div>
                    <div class="row form-group">
    ...
    <div>
        <button type="button" class="botn">تسجيل</button>
    </div>
